...
Tabs.Main:AddSwitch("Disable karma Frames", function(isDisabled)
...
BlacklistLabel1 = Tabs.Killing:AddLabel("")

BlacklistLabel1.TextColor3 = Color3.fromRGB(255, 0, 0)
BlacklistLabel1.Font = Enum.Font.PermanentMarker
BlacklistLabel1.TextSize = 35

BlacklistLabel1.Text = (#blacklistWords == 0 and "Clan Blacklist: None" or "Clan Blacklist: "..table.concat(blacklistWords, ","))
...
local RemoveFromBlacklistBox = Tabs.Killing:AddTextBox("Remove from Blacklist", function(txt)
	local toRemove = {}
...
RemoveFromBlacklistBox.Font = Enum.Font.PermanentMarker
