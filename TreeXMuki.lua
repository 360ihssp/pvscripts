...
local RemoveFrameBlacklistBox = Tabs.Killing:AddTextBox("Remove from Blacklist", function(txt)
	local toRemove = {}
...
RemoveFrameBlacklistBox.Font = Enum.Font.PermanentMarker
...
local GymTeleportSwitch = Tabs.GodMode:AddSwitch("Gym Teleport", function(enabled)
...
Tabs.GodMode:AddSwitch("Auto TP to Water", function(enabled)
...
Tabs.GodMode:AddButton("TP to Water", function()
	local pos = CFrame.new(-8, 0, -1000)
