...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/360ihssp/pvscripts/refs/heads/main/DESTROYERUI", true))()
...
Tabs.Killing:AddSwitch("Fast Punch", function(state)
